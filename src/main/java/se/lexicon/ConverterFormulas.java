...
public class ConverterFormulas {
    ...
    public static double sekToUsd(double sek) { return sek * 0.11; }

    /** USD to SEK: SEK = USD / 0.11 */
    public static double usdToSek(double usd) { return usd / 0.11; }

    /** SEK to EUR: EUR = SEK * 0.093 */
    public static double sekToEur(double sek) { return sek * 0.093; }

    /** EUR to SEK: SEK = EUR / 0.093 */
    public static double eurToSek(double eur) { return eur / 0.093; }
    ...
    public static double kmToM(double km) { return km * 1000; }

    /** Meters to Kilometers: KM = M / 1000 */
    public static double mToKm(double m) { return m / 1000; }
    ...
    public static double kgToG(double kg) { return kg * 1000; }

    /** Grams to Kilograms: KG = G / 1000 */
    public static double gToKg(double g) { return g / 1000; }
    ...
    public static double hoursToMinutes(double hours) { return hours * 60; }

    /** Minutes to Hours: Hours = Minutes / 60 */
    public static double minutesToHours(double minutes) { return minutes / 60; }
    ...
    public static double lPer100kmToKmPerL(double lPer100km) { return 100 / lPer100km; }

    /** KM/L to L/100KM: L/100KM = 100 ÷ KM/L */
    public static double kmPerLToLPer100km(double kmPerL) { return 100 / kmPerL; }
    ...
    /** KB to MB: MB = KB ÷ 1024 */
    public static double kbToMb(double kb) { return kb / 1024; }

    /** MB to KB: KB = MB * 1024 */
    public static double mbToKb(double mb) { return mb * 1024; }

    /** MB to GB: GB = MB ÷ 1024 */
    public static double mbToGb(double mb) { return mb / 1024; }

    /** GB to MB: MB = GB * 1024 */
    public static double gbToMb(double gb) { return gb * 1024; }
